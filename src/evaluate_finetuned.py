...
def plot_metrics(metrics, disease_cols, save_path="../outputs/Fine_Tuned/"):
    """
...
def confusion_matrix_per_class(y_true, y_pred, disease_cols, save_path="../outputs/Fine_Tuned/"):
    """
...
def plot_top_performing_diseases(metrics, disease_cols, y_true, y_probas, top_n=7, save_path="../outputs/Fine_Tuned/"):
    """
...
def plot_tsne_visualization(features, y_true, top_indices, disease_cols, save_path="../outputs/Fine_Tuned/"):
    """
...
def main():
    ...
    model_path = "fine_tuned_model.pth"  # Path to your saved model
