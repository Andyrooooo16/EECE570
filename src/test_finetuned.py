...
def plot_metrics(metrics, disease_cols, save_path="../outputs/Test/", selected_diseases=None):
...
def confusion_matrix_per_class(y_true, y_pred, disease_cols, save_path="../outputs/Test/", selected_diseases=None):
...
def plot_selected_diseases_metrics(metrics, disease_cols, y_true, y_probas, selected_diseases, save_path="../outputs/Test/"):
